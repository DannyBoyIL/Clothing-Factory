            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-10">
                        ...
                        <p class="lead">Please, <a href="{{ url('') }}" class="text-bold">start from the homepage</a> or <a href="{{ url('') }}" class="text-bold">contact our support</a>.</p>
                    </div>
                </div>
            </div>
        </section>
