            ...
            <div class="page-sidebar">
                ...
                <ul id="side-nav" class="main-menu navbar-collapse collapse">
                    <li class="has-sub active "><a href="index.html"><i class="icon-gauge"></i><span class="title">Dashboard</span></a>
                        <ul class="nav">
                            <li><a href="{{ url('cms/menu') }}"><span class="title">Misc.</span></a></li>
                            <li class="active"><a href="{{ url('cms/menu') }}"><span class="title">E-Commerce</span></a></li>
                            <li><a href="{{ url('cms/content') }}"><span class="title">News Portal</span></a></li>
                        </ul>
                    </li>
