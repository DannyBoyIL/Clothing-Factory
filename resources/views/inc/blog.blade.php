        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="post d-flex align-items-center flex-md-row flex-column">
                    ...
                    <div class="info"> 
                        <h4 class="h5"> <a href="{{ url('') }}">Egestas mus a mus rhoncus adipiscing iaculis facolisis             </a></h4><span class="date"><i class="fa fa-clock-o"></i>May 10th 2016</span>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p><a href="{{ url('') }}" class="read-more">Read More<i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
